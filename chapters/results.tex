...
This chapter combines the analysis components outlined in previous chapters with different definitions of the astrophysical neutrino flux and applies the statistical inference techniques of \refsec{sec:statistics} to the analysis structure of \reffig{fig:analysis_design}.
