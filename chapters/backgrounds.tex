...
Single atmospheric neutrinos are able to produce the same event signatures as astrophysical neutrinos because they are not fundamentally different from astrophysical neutrinos.
...
This analysis refrains from directly using prior information from other IceCube neutrino studies in order to provide results independent of other neutrino samples.
...
The na\"ive approximation of the muon yield using $\ECR$ without the subtraction of $E_p$ tends to underestimate the passing fraction as can be seen in Fig.~\ref{fig:nue_passing-double-counting}.
...
However, IceCube and other neutrino detectors are large enough that the change in depth from top to bottom significantly changes the overburden for a neutrino of a given zenith angle.
