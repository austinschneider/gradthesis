...
This efficiency is referred to as the ``veto passing fraction'', and denoted by $\mathcal{P}^{i,\alpha}_{passing}$, for each neutrino flavor $\alpha$.
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{results/HESE_Final_P% The text below describes the passing fraction calculation used in the six year analysis
		...
		%This functional form was fit to dedicated \CORSIKA simulation~\cite{Heck:1998vt,Heck:2018,Jero:2016abf,Gaisser:2014bja} generated with the SIBYLL 2.1~\cite{Ahn:2009wx} hadronic model and weighted to the Hillas-Gaisser H4a~\cite{Gaisser:2013bla} cosmic-ray flux.aper/figures/diffuse_hist_all_muons}
	\internallinenumbers
