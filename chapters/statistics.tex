...
\end{equation}
where the distribution of $\lambda$, $\prob\left(\lambda|\vecw(\vectheta)\right)$, is inferred from the MC. %Note that to obtain $\like_{\textrm General}$ we have implicitly made the assumption that $\prob(w_i'|\vectheta)=\delta(w_i'-w_i(\vectheta))$ for each event $i$ in the bin, and integrated over all possible $\vec{w_i'}$.
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5856\linewidth]{figures/stats_paper/fig1_contour}
...
\begin{figure}[htp]
	...
	\centering
	\subfloat{
		\includegraphics[width=0.48\linewidth]{figures/stats_paper/fig2_sigma}
	}
	\subfloat{
		\includegraphics[width=0.48\linewidth]{figures/stats_paper/fig2_f}
	}
...
\begin{figure}[htp]
	%\input{tikz/mc_diagram/mc_diagram}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=1.\linewidth]{figures/stats_paper/fig4}
...
\begin{figure}[htp]
	...
	\centering
	\subfloat{
		\includegraphics[width=0.48\linewidth]{{{figures/stats_paper/fig5_1_1e3}}}
	}
	\subfloat{
		\includegraphics[width=0.48\linewidth]{figures/stats_paper/fig5_1_1e6}
	}
