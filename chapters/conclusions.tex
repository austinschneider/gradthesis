...
A reasonable way to achieve this is more stringent quality cuts, which will reduce the effective area but potentially remove events that are more poorly modeled by simulation.
Similar steps have been taken in the sample used for eV scale sterile neutrino searches, but at lower energies.

\subsubsection{Low-energy through-going muon neutrinos}
